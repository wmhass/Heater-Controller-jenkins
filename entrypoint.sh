...
ROOT_HOME_ID_RSA=$JENKINS_HOME_SSH_DIR"/id_rsa"
ROOT_HOME_ID_RSA_PUB=$JENKINS_HOME_SSH_DIR"/id_rsa.pub"
...
if [ ! -d $ROOT_HOME_SSH_DIR ]; then mkdir $ROOT_HOME_SSH_DIR; fi
